...
{
    [Collection("General")]
    public class GetMineByIdAsync(Fixture fixture) : LightUnitTestCase<GetMineByIdAsync, Fixture>(fixture)
    {
        [Theory]
        ...
        {
            var wrapper = Fixture.Api.WithRole(userId).Get<Response<NotificationVM>>($"mine/{id}");
